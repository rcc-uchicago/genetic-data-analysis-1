...
+ Steps:
    ...
    3. Import genotypes into R.

    4. Fill in missing genotypes.

    5. Compute PCs using rsvd package, and save PCA results.
...
Run these lines of code to load the plotting packages and some
functions I defined for creating the PCA plots.
