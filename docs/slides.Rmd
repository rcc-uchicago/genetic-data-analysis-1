...
2. Start up interative R environment.
...
Start up R interactive environment
==================================
...
The third command will dramatically speed up the PCA calculations
by using multithreaded matrix operations from the OpenBLAS library.
