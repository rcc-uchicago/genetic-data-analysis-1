...
See the code for this function in `geno.utils.R`. It uses ggplot2 to
create the plot.

This plot shows structure in the adta, but it is difficult to
interpret. Next, let's create a similar plot with the samples drawn
according to their assigned population labels.
