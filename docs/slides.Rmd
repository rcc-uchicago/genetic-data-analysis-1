...
Let's run some simple shell commands to expore the genotype data
...
Command details:
    - Creates files `1kg.map` and `1kg.ped`.
    - Retains only SNPs on (autosomal) chromosomes 1-22.
    - Removes any SNPs in which the proportion of missing genotypes is >1%.
