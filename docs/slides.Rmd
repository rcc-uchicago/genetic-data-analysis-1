...
Assuming we didn't encounter any problems, let's save the results of
our analysis in the `output` folder.
...
+ Needs to be encoded as a numeric matrix.

+ Give more details `rpca` arguments.

+ Other software deals more elegantly with missing data; here is does
not matter much.

+ Point to sbatch script, and give instructions on how to use it.
