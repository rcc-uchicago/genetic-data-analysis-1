...
+ Usually the majority of the effort goes toward data processing.

+ It is very common to introduce errors when merging multiple data sets

+ PLINK will correct some errors, but not all of them.

+ I was conservative in selecting SNP common to both data sets.
