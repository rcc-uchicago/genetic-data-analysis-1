...
We will use the data from the "1000 Genomes" study.
...
Alternatively, you may download an up-to-date version of PLINK in the
same place as the other workshop materials.
...
wget https://go.aws/38KfiAE -O plink.zip
unzip plink.zip
./plink --version
```
...
format (then remove the large "ped" file).
...
disequibilirium) to make analysis better supported.
...
+ It is helpful to record your data processing steps.
