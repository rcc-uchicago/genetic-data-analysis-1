...
I wrote a function to import the genotypes into a matrix. It uses
...
Get the projection of the genotype samples onto the 10 PCs:
...
Add the labels to the PCs matrix:

```{r add-pop-labels}
pcs    <- as.data.frame(pcs)
ids    <- sapply(strsplit(rownames(pcs),"_"),"[",2)
