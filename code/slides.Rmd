...
human genetics, starting with the **original source data**, and ending
with a **visualization of population structure** estimated from the
genetic data.

2. Get familiar with standard file formats for genetic data (e.g.,
VCF, PLINK).

3. Learn basic elements of processing and analyzing genetic data.
...
4. We will use the most common technique---Principal Components
Analysis (PCA)---to infer population structure from the genetic data.
...
onto your laptop, and open **handout.pdf** using your favourite PDF
viewer.
...
genetic-data-analysis-1
  ...
  /data    # All data--original and processed.
