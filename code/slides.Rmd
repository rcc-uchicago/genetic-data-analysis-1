...
Download the git reposistory to your home directory.

* URL: https://github.com/rcc-uchicago/genetic-data-analysis-1

On the RCC cluster, run these commands to download the repository:

```{bash download-repo, eval=FALSE}
cd ~
git clone git@github.com:rcc-uchicago/genetic-data-analysis-1.git
```
...
genetic-data-analysis-1
  ...
  /docs    # Additional materials for workshop.
